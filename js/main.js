...
document.getElementById("popup1").getElementByClassName("close")[0].addEventListener("click"), function() {
...
document
  ...
  .addEventListener("click", function() {
    ...
    if (validationResults === true) {
      document.getElementsById("popup1").style.visibility = "hidden";
      document.getElementsById("popup2").style.visibility = "visible";
    }
  });
